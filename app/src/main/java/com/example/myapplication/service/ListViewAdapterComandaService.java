...
public class ListViewAdapterComandaService extends BaseAdapter {
    ...
    public ListViewAdapterComandaService(Activity activity, ArrayList<ComandaView> list){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtLast.setText("R$ "+map.getValor());
